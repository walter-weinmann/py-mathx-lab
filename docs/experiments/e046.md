...
```{figure} ../_static/experiments/e046_hero.png
:width: 80%
:alt: Preview figure for E046
```
...
- Recommended: `make run EXP=e046`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e046`

Optional arguments:

- `make run EXP=e046 ARGS="--seed 123 --n 200000"`
