...
```{figure} ../_static/experiments/e021_hero.png
:width: 80%
:alt: Preview figure for E021
```
...
- Recommended: `make run EXP=e021`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e021`

Optional arguments:

- `make run EXP=e021 ARGS="--seed 123 --n 200000"`
