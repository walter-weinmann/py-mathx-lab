...
```{figure} ../_static/experiments/e030_hero.png
:width: 80%
:alt: Preview figure for E030
```
...
- Recommended: `make run EXP=e030`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e030`

Optional arguments:

- `make run EXP=e030 ARGS="--seed 123 --n 200000"`
