...
```{figure} ../_static/experiments/e045_hero.png
:width: 80%
:alt: Preview figure for E045
```
...
- Recommended: `make run EXP=e045`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e045`

Optional arguments:

- `make run EXP=e045 ARGS="--seed 123 --n 200000"`
