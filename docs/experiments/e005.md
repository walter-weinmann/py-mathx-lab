...
```bash
uv run --extra dev python -m mathxlab.experiments.e005
```
...
- Primary: {cite:p}`Voight1998PerfectNumbersElementaryIntroduction,OchemRao2014LowerBoundsOddPerfectNumbersSlides,Stone2024ImprovedUpperBoundsOddPerfectNumbersPartI,Guy2004UnsolvedProblemsInNumberTheory`
...
- {doc}`e046` (Prime-testing pipeline and tuning pitfalls)
