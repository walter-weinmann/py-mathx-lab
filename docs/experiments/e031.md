...
```{figure} ../_static/experiments/e031_hero.png
:width: 80%
:alt: Preview figure for E031
```
...
- Recommended: `make run EXP=e031`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e031`

Optional arguments:

- `make run EXP=e031 ARGS="--seed 123 --n 200000"`
