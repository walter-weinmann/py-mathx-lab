...
- Primary: See {cite:t}`AlfordGranvillePomerance1994InfinitelyManyCarmichaelNumbers`, {cite:t}`Carmichael1912CompositeNumbersSatisfyingFermatTheorem`, {cite:t}`OEISFoundationInc2025A002997CarmichaelNumbers`, {cite:t}`WikipediaContributors2025CarmichaelNumber`.
