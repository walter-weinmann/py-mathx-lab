...
```{figure} ../_static/experiments/e001_hero_0.png
:width: 80%
:alt: Preview figure for E001
```

```{figure} ../_static/experiments/e001_hero_1.png
:width: 80%
:alt: Preview figure for E001
```

```{figure} ../_static/experiments/e001_hero_2.png
:width: 80%
:alt: Preview figure for E001
```

**Tags:** `analysis`, `quantitative-exploration`, `visualization`, `numerics`, `taylor`
See: {doc}`../tags`.
...
- Recommended: `make run EXP=e001`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e001`
...
{cite:p}`BaileyBorwein2005ExperimentalMathematics,Borwein2005ExperimentalMathematician,BorweinBailey2008MathematicsByExperiment`
