...
```{figure} ../_static/experiments/e037_hero.png
:width: 80%
:alt: Preview figure for E037
```
...
- Recommended: `make run EXP=e037`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e037`

Optional arguments:

- `make run EXP=e037 ARGS="--seed 123 --n 200000"`
