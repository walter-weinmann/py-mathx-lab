...
```{figure} ../_static/experiments/e027_hero.png
:width: 80%
:alt: Preview figure for E027
```
...
- Recommended: `make run EXP=e027`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e027`

Optional arguments:

- `make run EXP=e027 ARGS="--seed 123 --n 200000"`
