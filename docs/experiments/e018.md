...
```{figure} ../_static/experiments/e018_hero.png
:width: 80%
:alt: Preview figure for E018
```
...
- Recommended: `make run EXP=e018`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e018`

Optional arguments:

- `make run EXP=e018 ARGS="--seed 123 --n 200000"`
