...
```{figure} ../_static/experiments/e039_hero.png
:width: 80%
:alt: Preview figure for E039
```
...
- Recommended: `make run EXP=e039`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e039`

Optional arguments:

- `make run EXP=e039 ARGS="--seed 123 --n 200000"`
