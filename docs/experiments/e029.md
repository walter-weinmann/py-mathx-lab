...
```{figure} ../_static/experiments/e029_hero.png
:width: 80%
:alt: Preview figure for E029
```
...
- Recommended: `make run EXP=e029`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e029`

Optional arguments:

- `make run EXP=e029 ARGS="--seed 123 --n 200000"`
...
- {doc}`e006` (Near Misses to Perfection)
