...
```{figure} ../_static/experiments/e034_hero.png
:width: 80%
:alt: Preview figure for E034
```
...
- Recommended: `make run EXP=e034`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e034`

Optional arguments:

- `make run EXP=e034 ARGS="--seed 123 --n 200000"`
