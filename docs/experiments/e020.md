...
```{figure} ../_static/experiments/e020_hero.png
:width: 80%
:alt: Preview figure for E020
```
...
```{figure} ../_static/experiments/e020_hero_2.png
:width: 80%
:alt: Preview figure for E020
```
...
- Recommended: `make run EXP=e020`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e020`

Optional arguments:

- `make run EXP=e020 ARGS="--seed 123 --n 200000"`
