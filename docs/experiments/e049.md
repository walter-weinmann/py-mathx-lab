...
- Primary: See {cite:t}`Wieferich1909ZumLetztenFermatschenTheorem`, {cite:t}`OEISFoundationInc2025A001220WieferichPrimes`, {cite:t}`WikipediaContributors2025WieferichPrime`.
