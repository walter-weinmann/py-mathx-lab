...
```{figure} ../_static/experiments/e028_hero.png
:width: 80%
:alt: Preview figure for E028
```
...
- Recommended: `make run EXP=e028`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e028`

Optional arguments:

- `make run EXP=e028 ARGS="--seed 123 --n 200000"`
