...
```{figure} ../_static/experiments/e038_hero.png
:width: 80%
:alt: Preview figure for E038
```
...
- Recommended: `make run EXP=e038`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e038`

Optional arguments:

- `make run EXP=e038 ARGS="--seed 123 --n 200000"`
