...
## How to run
- Recommended: `make run EXP=e047`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e047`

Optional arguments:

- `make run EXP=e047 ARGS="--seed 123 --n 200000"`
...
- {doc}`e015` (Wilson test infeasibility)
- {doc}`e041` (Fermat numbers: not all prime)
