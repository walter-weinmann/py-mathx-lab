...
- Primary: See {cite:t}`KrizekLucaSomer2013LecturesOnFermatNumbers`, {cite:t}`WikipediaContributors2025FermatNumber`, {cite:t}`OEISFoundationInc2025A000215FermatNumbers`.
