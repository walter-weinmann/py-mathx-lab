...
```{figure} ../_static/experiments/e006_hero_2.png
:width: 80%
:alt: Preview figure for E006
```
...
```bash
uv run --extra dev python -m mathxlab.experiments.e006
```
...
- Primary: {cite:p}`OEIS2025A000396PerfectNumbers,Voight1998PerfectNumbersElementaryIntroduction,Weisstein2003PerfectNumberMathWorld`
