...
```bash
uv run --extra dev python -m mathxlab.experiments.e008
```
...
- Primary: {cite:p}`WikipediaContributors2025LucasLehmerPrimalityTest,Caldwell2021MersennePrimesPrimePages,MersenneResearchInc2024GIMPSMathPrimeNet`
