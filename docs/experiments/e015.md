...
```{figure} ../_static/experiments/e015_hero.png
:width: 80%
:alt: Preview figure for E015
```
...
- Recommended: `make run EXP=e015`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e015`

Optional arguments:

- `make run EXP=e015 ARGS="--seed 123 --n 200000"`
