...
- Recommended: `make run EXP=e062`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e062`

Optional arguments:

- `make run EXP=e062 ARGS="--seed 123 --n 200000"`
...
See {cite:t}`erdospomeranceschmutz1991carmichaelslambdafunction`, {cite:t}`montgomeryvaughan2006multiplicativenumbertheoryi`.
