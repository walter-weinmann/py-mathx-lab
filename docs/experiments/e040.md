...
```{figure} ../_static/experiments/e040_hero.png
:width: 80%
:alt: Preview figure for E040
```
...
- Recommended: `make run EXP=e040`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e040`

Optional arguments:

- `make run EXP=e040 ARGS="--seed 123 --n 200000"`
