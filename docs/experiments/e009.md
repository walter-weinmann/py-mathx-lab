...
```bash
uv run --extra dev python -m mathxlab.experiments.e009
```
...
- Primary: {cite:p}`WikipediaContributors2025MersennePrime,Caldwell2021MersennePrimesPrimePages,OEIS2025A001348MersenneNumbers`
