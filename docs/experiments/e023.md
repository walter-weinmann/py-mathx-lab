...
```{figure} ../_static/experiments/e023_hero.png
:width: 80%
:alt: Preview figure for E023
```
...
- Recommended: `make run EXP=e023`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e023`

Optional arguments:

- `make run EXP=e023 ARGS="--seed 123 --n 200000"`
