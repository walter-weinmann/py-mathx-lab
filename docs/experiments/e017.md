...
```{figure} ../_static/experiments/e017_hero.png
:width: 80%
:alt: Preview figure for E017
```
...
- Recommended: `make run EXP=e017`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e017`

Optional arguments:

- `make run EXP=e017 ARGS="--seed 123 --n 200000"`
