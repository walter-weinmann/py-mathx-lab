...
```{figure} ../_static/experiments/e016_hero.png
:width: 80%
:alt: Preview figure for E016
```
...
- Recommended: `make run EXP=e016`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e016`

Optional arguments:

- `make run EXP=e016 ARGS="--seed 123 --n 200000"`
...
- {doc}`e044` (Solovay–Strassen vs. Miller–Rabin (liars))
