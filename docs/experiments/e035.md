...
```{figure} ../_static/experiments/e035_hero.png
:width: 80%
:alt: Preview figure for E035
```
...
- Recommended: `make run EXP=e035`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e035`

Optional arguments:

- `make run EXP=e035 ARGS="--seed 123 --n 200000"`
...
- {doc}`e036` (Prime arithmetic progressions (small search))
