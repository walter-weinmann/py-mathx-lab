...
```{figure} ../_static/experiments/e032_hero.png
:width: 80%
:alt: Preview figure for E032
```
...
- Recommended: `make run EXP=e032`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e032`

Optional arguments:

- `make run EXP=e032 ARGS="--seed 123 --n 200000"`
