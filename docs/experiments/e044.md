...
```{figure} ../_static/experiments/e044_hero.png
:width: 80%
:alt: Preview figure for E044
```
...
- Recommended: `make run EXP=e044`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e044`

Optional arguments:

- `make run EXP=e044 ARGS="--seed 123 --n 200000"`
...
- {doc}`e016` (Trial division vs. Miller–Rabin scaling)
