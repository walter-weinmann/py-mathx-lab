...
```{figure} ../_static/experiments/e002_hero_2.png
:width: 80%
:alt: Preview figure for E002
```

```{figure} ../_static/experiments/e002_hero_3.png
:width: 80%
:alt: Preview figure for E002
```
...
- Recommended: `make run EXP=e002`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e002`

Optional arguments:

- `make run EXP=e002 ARGS="--seed 123 --n 200000"`
