...
```bash
uv run --extra dev python -m mathxlab.experiments.e002
```
...
- Primary: {cite:p}`Caldwell2000EvenPerfectNumbersPrimePages,OEIS2025A000396PerfectNumbers,Voight1998PerfectNumbersElementaryIntroduction`
