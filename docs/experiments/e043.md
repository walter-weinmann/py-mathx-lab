...
```{figure} ../_static/experiments/e043_hero.png
:width: 80%
:alt: Preview figure for E043
```
...
- Recommended: `make run EXP=e043`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e043`

Optional arguments:

- `make run EXP=e043 ARGS="--seed 123 --n 200000"`
