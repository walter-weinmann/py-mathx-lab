...
```{figure} ../_static/experiments/e026_hero.png
:width: 80%
:alt: Preview figure for E026
```
...
- Recommended: `make run EXP=e026`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e026`

Optional arguments:

- `make run EXP=e026 ARGS="--seed 123 --n 200000"`
...
- {doc}`e033` (Bounded gaps vs. twin primes (not the same))
