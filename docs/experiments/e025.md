...
```{figure} ../_static/experiments/e025_hero.png
:width: 80%
:alt: Preview figure for E025
```
...
- Recommended: `make run EXP=e025`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e025`

Optional arguments:

- `make run EXP=e025 ARGS="--seed 123 --n 200000"`
