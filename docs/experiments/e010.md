...
```bash
uv run --extra dev python -m mathxlab.experiments.e010
```
...
- Primary: {cite:p}`Caldwell2000EvenPerfectNumbersPrimePages,WikipediaContributors2025MersennePrime,OEIS2025A000043MersenneExponents`
