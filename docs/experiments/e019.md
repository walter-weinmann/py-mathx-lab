...
```{figure} ../_static/experiments/e019_hero.png
:width: 80%
:alt: Preview figure for E019
```
...
```{figure} ../_static/experiments/e019_hero_2.png
:width: 80%
:alt: Preview figure for E019
```
...
- Recommended: `make run EXP=e019`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e019`

Optional arguments:

- `make run EXP=e019 ARGS="--seed 123 --n 200000"`
