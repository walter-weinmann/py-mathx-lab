...
```bash
uv run --extra dev python -m mathxlab.experiments.e003
```
...
- Primary: {cite:p}`Weisstein2003PerfectNumberMathWorld,OEIS2025A000396PerfectNumbers,Voight1998PerfectNumbersElementaryIntroduction`
