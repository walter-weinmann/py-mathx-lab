...
```{figure} ../_static/experiments/e042_hero.png
:width: 80%
:alt: Preview figure for E042
```
...
- Recommended: `make run EXP=e042`
- Direct: `uv run --extra dev python -m mathxlab.experiments.e042`

Optional arguments:

- `make run EXP=e042 ARGS="--seed 123 --n 200000"`
