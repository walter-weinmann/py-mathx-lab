...
This page provides a *lightweight* mathematical background for experiments that use Taylor polynomials and
truncation error.

## Taylor polynomial

Let $f$ be sufficiently differentiable near $x_0$. The Taylor polynomial of degree $n$ around $x_0$ is
$$
...
Even when the mathematics is correct, computation can mislead:

- large $|x-x_0|$ and high $n$ can produce very large intermediate terms,
