...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e122",
        description="Heatmap atlas: μ, ω, Ω textures",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e122")
    ...
    logger.info("Starting experiment E122")
    run_e122(
    ...
    logger.info(
        "Experiment E122 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
