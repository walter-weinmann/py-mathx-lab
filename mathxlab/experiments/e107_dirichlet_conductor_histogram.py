...
from mathxlab.experiments.number_theory_suite import run_e107
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e107",
        description="Conductor: primitive vs imprimitive",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e107")
    ...
    logger.info("Starting experiment E107")
    run_e107(
    ...
    logger.info(
        "Experiment E107 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
