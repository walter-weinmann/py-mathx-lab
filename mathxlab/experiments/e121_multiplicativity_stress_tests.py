"""E121: Multiplicativity stress tests.
...
from mathxlab.experiments.number_theory_suite import run_e121
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e121",
        description="Multiplicativity stress tests",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e121")
    ...
    logger.info("Starting experiment E121")
    run_e121(
    ...
    logger.info(
        "Experiment E121 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
