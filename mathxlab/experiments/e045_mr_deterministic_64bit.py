...
from mathxlab.experiments.prime_suite import run_e045
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e045",
        description="Deterministic 64-bit MR base sets",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e045")
    ...
    logger.info("Starting experiment E045")
    run_e045(
    ...
    logger.info("Experiment E045 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
