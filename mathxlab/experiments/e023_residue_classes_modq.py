...
from mathxlab.experiments.prime_suite import run_e023
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e023",
        description="Residue class distribution mod q",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e023")
    ...
    logger.info("Starting experiment E023")
    run_e023(
    ...
    logger.info("Experiment E023 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
