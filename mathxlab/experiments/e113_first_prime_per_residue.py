...
from mathxlab.experiments.number_theory_suite import run_e113
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e113",
        description="First prime in each residue class",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e113")
    ...
    logger.info("Starting experiment E113")
    run_e113(
    ...
    logger.info(
        "Experiment E113 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
