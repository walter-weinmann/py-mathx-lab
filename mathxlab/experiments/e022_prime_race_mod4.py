...
from mathxlab.experiments.prime_suite import run_e022
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e022",
        description="Prime race modulo 4",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e022")
    ...
    logger.info("Starting experiment E022")
    run_e022(
    ...
    logger.info("Experiment E022 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
