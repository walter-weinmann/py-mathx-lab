...
from mathxlab.experiments.number_theory_suite import run_e119
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e119",
        description="ψ(x)−x oscillations (smoothed view)",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e119")
    ...
    logger.info("Starting experiment E119")
    run_e119(
    ...
    logger.info(
        "Experiment E119 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
