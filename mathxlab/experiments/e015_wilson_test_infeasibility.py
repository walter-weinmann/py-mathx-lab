...
from mathxlab.experiments.prime_suite import run_e015
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e015",
        description="Wilson test infeasibility",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e015")
    ...
    logger.info("Starting experiment E015")
    run_e015(
    ...
    logger.info("Experiment E015 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
