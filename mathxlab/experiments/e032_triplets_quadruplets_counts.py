...
from mathxlab.experiments.prime_suite import run_e032
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e032",
        description="Prime triplets and quadruplets",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e032")
    ...
    logger.info("Starting experiment E032")
    run_e032(
    ...
    logger.info("Experiment E032 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
