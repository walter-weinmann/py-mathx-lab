...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e096",
        description="τ(n) record-holders",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e096")
    ...
    logger.info("Starting experiment E096")
    run_e096(
    ...
    logger.info(
        "Experiment E096 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
