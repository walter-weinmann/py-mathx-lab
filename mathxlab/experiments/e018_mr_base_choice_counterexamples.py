...
from mathxlab.experiments.prime_suite import run_e018
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e018",
        description="Miller–Rabin base choice counterexamples",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e018")
    ...
    logger.info("Starting experiment E018")
    run_e018(
    ...
    logger.info("Experiment E018 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
