"""E117 — χ-factor checks for functional equation.
...
from mathxlab.experiments.number_theory_suite import run_e117
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e117",
        description="χ-factor checks for functional equation",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e117")
    ...
    logger.info("Starting experiment E117")
    run_e117(
    ...
    logger.info(
        "Experiment E117 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
