...
from mathxlab.experiments.prime_suite import run_e039
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e039",
        description="Sophie Germain and safe primes",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e039")
    ...
    logger.info("Starting experiment E039")
    run_e039(
    ...
    logger.info("Experiment E039 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
