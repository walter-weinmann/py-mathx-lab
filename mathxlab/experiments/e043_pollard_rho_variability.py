...
from mathxlab.experiments.prime_suite import run_e043
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e043",
        description="Pollard rho runtime variability",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e043")
    ...
    logger.info("Starting experiment E043")
    run_e043(
    ...
    logger.info("Experiment E043 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
