...
from mathxlab.experiments.prime_suite import run_e034
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e034",
        description="Twin primes in sliding windows",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e034")
    ...
    logger.info("Starting experiment E034")
    run_e034(
    ...
    logger.info("Experiment E034 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
