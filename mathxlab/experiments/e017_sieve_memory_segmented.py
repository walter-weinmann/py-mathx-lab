...
from mathxlab.experiments.prime_suite import run_e017
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e017",
        description="Sieve memory blow-up vs segmented sieve",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e017")
    ...
    logger.info("Starting experiment E017")
    run_e017(
    ...
    logger.info("Experiment E017 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
