"""E120 — Pretentious distance proxy: χ vs 1 on primes.
...
from mathxlab.experiments.number_theory_suite import run_e120
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e120",
        description="Pretentious distance proxy: χ vs 1 on primes",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e120")
    ...
    logger.info("Starting experiment E120")
    run_e120(
    ...
    logger.info(
        "Experiment E120 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
