...
from mathxlab.experiments.prime_suite import run_e040
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e040",
        description="Palindromic primes and the '11 trap'",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e040")
    ...
    logger.info("Starting experiment E040")
    run_e040(
    ...
    logger.info("Experiment E040 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
