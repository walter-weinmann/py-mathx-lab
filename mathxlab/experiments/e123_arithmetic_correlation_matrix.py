...
from mathxlab.experiments.number_theory_suite import run_e123
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e123",
        description="Correlation matrix of arithmetic functions",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e123")
    ...
    logger.info("Starting experiment E123")
    run_e123(
    ...
    logger.info(
        "Experiment E123 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
