...
from mathxlab.experiments.prime_suite import run_e028
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e028",
        description="Jumping champions (most frequent gaps)",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e028")
    ...
    logger.info("Starting experiment E028")
    run_e028(
    ...
    logger.info("Experiment E028 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
