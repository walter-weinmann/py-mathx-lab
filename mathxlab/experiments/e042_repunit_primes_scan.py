...
from mathxlab.experiments.prime_suite import run_e042
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e042",
        description="Repunit primes (small k scan)",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e042")
    ...
    logger.info("Starting experiment E042")
    run_e042(
    ...
    logger.info("Experiment E042 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
