...
from mathxlab.experiments.prime_suite import run_e026
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e026",
        description="Normalized prime gaps",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e026")
    ...
    logger.info("Starting experiment E026")
    run_e026(
    ...
    logger.info("Experiment E026 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
