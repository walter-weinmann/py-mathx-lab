...
from mathxlab.experiments.number_theory_suite import run_e103
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e103",
        description="Chebyshev ψ(x): prime powers",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e103")
    ...
    logger.info("Starting experiment E103")
    run_e103(
    ...
    logger.info(
        "Experiment E103 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
