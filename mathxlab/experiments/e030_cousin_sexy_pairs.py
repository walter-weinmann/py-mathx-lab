...
from mathxlab.experiments.prime_suite import run_e030
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e030",
        description="Cousin and sexy prime pairs",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e030")
    ...
    logger.info("Starting experiment E030")
    run_e030(
    ...
    logger.info("Experiment E030 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
