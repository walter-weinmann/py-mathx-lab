...
from mathxlab.experiments.number_theory_suite import run_e099
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e099",
        description="Jordan totients J_k atlas",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e099")
    ...
    logger.info("Starting experiment E099")
    run_e099(
    ...
    logger.info(
        "Experiment E099 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
