"""E110: Dirichlet L-series partial sums.
...
from mathxlab.experiments.number_theory_suite import run_e110
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e110",
        description="Dirichlet L-series partial sums",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e110")
    ...
    logger.info("Starting experiment E110")
    run_e110(
    ...
    logger.info(
        "Experiment E110 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
