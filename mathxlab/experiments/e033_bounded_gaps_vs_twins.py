...
from mathxlab.experiments.prime_suite import run_e033
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e033",
        description="Bounded gaps vs twin primes (not the same)",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e033")
    ...
    logger.info("Starting experiment E033")
    run_e033(
    ...
    logger.info("Experiment E033 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
