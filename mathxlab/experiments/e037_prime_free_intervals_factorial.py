...
from mathxlab.experiments.prime_suite import run_e037
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e037",
        description="Prime-free intervals via factorial construction",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e037")
    ...
    logger.info("Starting experiment E037")
    run_e037(
    ...
    logger.info("Experiment E037 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
