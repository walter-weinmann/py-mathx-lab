...
from mathxlab.experiments.number_theory_suite import run_e106
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e106",
        description="Dirichlet characters: real vs complex",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e106")
    ...
    logger.info("Starting experiment E106")
    run_e106(
    ...
    logger.info(
        "Experiment E106 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
