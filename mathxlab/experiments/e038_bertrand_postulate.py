...
from mathxlab.experiments.prime_suite import run_e038
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e038",
        description="Bertrand's postulate (computational verification)",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e038")
    ...
    logger.info("Starting experiment E038")
    run_e038(
    ...
    logger.info("Experiment E038 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
