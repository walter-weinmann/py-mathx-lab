...
from mathxlab.experiments.prime_suite import run_e021
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e021",
        description="Explicit bounds sanity checks",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e021")
    ...
    logger.info("Starting experiment E021")
    run_e021(
    ...
    logger.info("Experiment E021 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
