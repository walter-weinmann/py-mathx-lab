...
from mathxlab.experiments.number_theory_suite import run_e115
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e115",
        description="Hardy Z: zero bracketing via sign changes",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e115")
    ...
    logger.info("Starting experiment E115")
    run_e115(
    ...
    logger.info(
        "Experiment E115 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
