...
from mathxlab.experiments.prime_suite import run_e025
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e025",
        description="Prime gaps are not monotone",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e025")
    ...
    logger.info("Starting experiment E025")
    run_e025(
    ...
    logger.info("Experiment E025 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
