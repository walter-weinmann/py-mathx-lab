...
from mathxlab.experiments.number_theory_suite import run_e094
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e094",
        description="ω(n) vs Ω(n): Erdős–Kac side-by-side",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e094")
    ...
    logger.info("Starting experiment E094")
    run_e094(
    ...
    logger.info(
        "Experiment E094 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
