...
from mathxlab.experiments.number_theory_suite import run_e114
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e114",
        description="ζ via η: stability map on critical line",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e114")
    ...
    logger.info("Starting experiment E114")
    run_e114(
    ...
    logger.info(
        "Experiment E114 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
