...
from mathxlab.experiments.prime_suite import run_e027
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e027",
        description="Record prime gaps vs log^2 heuristic",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e027")
    ...
    logger.info("Starting experiment E027")
    run_e027(
    ...
    logger.info("Experiment E027 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
