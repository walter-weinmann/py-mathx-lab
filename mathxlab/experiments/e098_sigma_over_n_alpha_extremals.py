...
from mathxlab.experiments.number_theory_suite import run_e098
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e098",
        description="Extremals of σ(n)/n^α across α",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e098")
    ...
    logger.info("Starting experiment E098")
    run_e098(
    ...
    logger.info(
        "Experiment E098 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
