...
from mathxlab.experiments.number_theory_suite import run_e105
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e105",
        description="Mertens function M(x) scaling views",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e105")
    ...
    logger.info("Starting experiment E105")
    run_e105(
    ...
    logger.info(
        "Experiment E105 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
