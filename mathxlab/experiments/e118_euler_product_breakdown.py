...
from mathxlab.experiments.number_theory_suite import run_e118
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e118",
        description="Partial Euler product for ζ(s): where it breaks",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e118")
    ...
    logger.info("Starting experiment E118")
    run_e118(
    ...
    logger.info(
        "Experiment E118 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
