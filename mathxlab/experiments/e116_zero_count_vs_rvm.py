"""E116: Zero count proxy vs Riemann–von Mangoldt.
...
from mathxlab.experiments.number_theory_suite import run_e116
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e116",
        description="Zero count proxy vs Riemann–von Mangoldt",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e116")
    ...
    logger.info("Starting experiment E116")
    run_e116(
    ...
    logger.info(
        "Experiment E116 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
