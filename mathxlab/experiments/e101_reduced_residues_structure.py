...
from mathxlab.experiments.number_theory_suite import run_e101
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e101",
        description="Reduced residues: (ℤ/qℤ)× structure",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e101")
    ...
    logger.info("Starting experiment E101")
    run_e101(
    ...
    logger.info(
        "Experiment E101 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
