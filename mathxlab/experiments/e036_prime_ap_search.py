...
from mathxlab.experiments.prime_suite import run_e036
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e036",
        description="Prime arithmetic progressions (small search)",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e036")
    ...
    logger.info("Starting experiment E036")
    run_e036(
    ...
    logger.info("Experiment E036 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
