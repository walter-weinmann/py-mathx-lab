...
from mathxlab.experiments.number_theory_suite import run_e109
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e109",
        description="Gauss sums magnitude (prime modulus)",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e109")
    ...
    logger.info("Starting experiment E109")
    run_e109(
    ...
    logger.info(
        "Experiment E109 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
