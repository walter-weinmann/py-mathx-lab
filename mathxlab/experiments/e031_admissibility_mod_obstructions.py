...
from mathxlab.experiments.prime_suite import run_e031
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e031",
        description="Admissibility and modular obstructions",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e031")
    ...
    logger.info("Starting experiment E031")
    run_e031(
    ...
    logger.info("Experiment E031 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
