...
from mathxlab.experiments.prime_suite import run_e035
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e035",
        description="Primes in arithmetic progressions mod q",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e035")
    ...
    logger.info("Starting experiment E035")
    run_e035(
    ...
    logger.info("Experiment E035 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
