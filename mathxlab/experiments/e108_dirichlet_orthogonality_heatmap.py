...
from mathxlab.experiments.number_theory_suite import run_e108
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e108",
        description="Character orthogonality heatmap",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e108")
    ...
    logger.info("Starting experiment E108")
    run_e108(
    ...
    logger.info(
        "Experiment E108 completed successfully. Artifacts saved to: %s",
        args.out_dir,
    )
    return 0
