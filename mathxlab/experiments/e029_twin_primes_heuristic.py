...
from mathxlab.experiments.prime_suite import run_e029
...
def main() -> int:
    ...
    args = parse_experiment_args(
        experiment_id="e029",
        description="Twin primes: observed vs heuristic",
    )

    run_log = infer_run_log_file(out_dir=args.out_dir, experiment_slug="e029")
    ...
    logger.info("Starting experiment E029")
    run_e029(
    ...
    logger.info("Experiment E029 completed successfully. Artifacts saved to: %s", args.out_dir)
    return 0
